...
import com.mex.gt.mgr.service.MenuService;
import com.mex.gt.mgr.service.dto.MenuDTO;
import com.mex.gt.mgr.service.mapper.MenuMapper;
...
public class MenuResourceIntTest {
    ...
    private static final String DEFAULT_IS_SHOW = "AAAAAAAAAA";
    private static final String UPDATED_IS_SHOW = "BBBBBBBBBB";
    ...
    public void getAllMenus() throws Exception {
        ...
        restMenuMockMvc.perform(get("/api/menus?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isShow").value(hasItem(DEFAULT_IS_SHOW.toString())))
    ...
    public void getMenu() throws Exception {
        ...
        restMenuMockMvc.perform(get("/api/menus/{id}", menu.getId()))
            ...
            .andExpect(jsonPath("$.isShow").value(DEFAULT_IS_SHOW.toString()))
    ...
    public void testEntityFromId() {
        Assertions.assertThat(menuMapper.fromId(42L).getId()).isEqualTo(42);
        Assertions.assertThat(menuMapper.fromId(null)).isNull();
    }
}
